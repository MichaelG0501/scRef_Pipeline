...
# Analysis registry:
#   Status: legacy
#   Script: analysis/spatial/legacy_Auto_compare_xenium_state_methods.py
#   Description: Historical uncentred nMP=19 Xenium assignment comparison.
#     Retained for provenance; current mapping uses map_scatlas_states_xenium.py.
...
def parse_args():
    ...
    parser.add_argument(
        "--output-dir",
        default="/rds/general/project/tumourheterogeneity1/live/scRef_Pipeline/ref_outs/Auto_xenium_state_method_comparison",
    )
