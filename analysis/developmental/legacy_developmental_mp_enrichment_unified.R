...
# Analysis registry:
#   Status: legacy
#   Script: analysis/developmental/legacy_developmental_mp_enrichment_unified.R
#   Description: Historical nMP=19 developmental validation retained for
#     provenance. Current developmental annotations are produced in centred step 04.
...
#     - Rscript analysis/developmental/legacy_developmental_mp_enrichment_unified.R
####################
...
# This file is sourced by legacy_developmental_mp_enrichment_unified.R after inputs,
...
####################
# Manuscript status override (31 Jul 2026): legacy nMP19 comparison.
# Current developmental/alignment results for manuscript replotting come from
# analysis/metaprograms/centred/04_mp_refinement_merge_correlated_submps.R and
# its persistent live merged_refined_mp_external_ucell_scores.rds output.
####################
