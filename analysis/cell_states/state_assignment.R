...
state_order <- c("Classic_Prolif", "Squamous_Transition", "Intest_Diff_Columnar", "Plastic_Tolerant", "Unresolved", "Unassigned")
state_order <- c("Classic_Prolif", "Squamous_Transition", "Intest_Diff_Columnar", "Plastic_Tolerant", "Intest_Diff", "IFN_columnar", "Unresolved", "Unassigned")
...
state_order <- c("Stress_Columnar", "Classic_Prolif", "Stress_Prolif", "Columnar", "Stress_Plastic","Intest_Diff", "Unresolved", "Unassigned")

tmdata_pdos$manual_state <- factor(tmdata_pdos$manual_state, levels = state_order)

manual_names <- levels(tmdata_pdos$manual_state)
manual_cols <- c(
  "Stress_Columnar" = "green",  # Pink (hybrid state, distinct)
  "Classic_Prolif"         = "#E41A1C",  # Deep Red
