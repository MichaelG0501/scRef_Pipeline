...
# Analysis registry:
#   Status: legacy
#   Script: analysis/cell_states/legacy_cancer_summary.R
#   Methodology: analysis/methodology/cell_states/state_workflows_methodology.md
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Historical interactive malignancy-summary fragment. It contains
#     session-dependent epi/cs_genes references and has no persistent current output.
#   Inputs: ref_outs/by_samples/<sample>/<sample>_epi_f.rds and external Marker_Genes.xlsx.
#   Outputs: interactive plots only; no current dependency.
#   Run: provenance only; not for submission.
#   Conda env: dmtcp
####################

####################
# Moved from: analysis/sum_cancer.R
