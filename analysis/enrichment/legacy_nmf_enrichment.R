...
# Analysis registry:
#   Status: legacy
#   Script: analysis/enrichment/legacy_nmf_enrichment.R
#   Methodology: analysis/methodology/enrichment/enrichment_external_reference_methodology.md
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Historical interactive NMF enrichment fragment that depends on
#     undefined caller-session objects; centred step 04 is the current workflow.
#   Inputs: in-memory Genes_nmf_w_basis, final_nmf, overlap_list, and nmf_programs.
#   Outputs: historical nmf_gene_programs.xlsx in the caller directory.
