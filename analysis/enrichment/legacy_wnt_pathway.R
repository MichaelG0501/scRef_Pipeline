...
# Analysis registry:
#   Status: legacy
#   Script: analysis/enrichment/legacy_wnt_pathway.R
#   Methodology: analysis/methodology/enrichment/enrichment_external_reference_methodology.md
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Historical interactive WNT overlap fragment that requires
#     caller-created mp_gene_lists/universe objects and does not save a current output.
#   Inputs: in-memory mp_gene_lists and optional universe/mp_tree_order.
#   Outputs: interactive pheatmap only; no persistent current output.
