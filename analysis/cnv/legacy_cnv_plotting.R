...
# Analysis registry:
#   Status: legacy
#   Script: analysis/cnv/legacy_cnv_plotting.R
#   Methodology: analysis/methodology/cnv/cnv_workflows_methodology.md
#   Map: analysis/ANALYSIS_MAP.md
#   Description: Historical PDO/reference CNA heatmap fragment. It infers sample
#     identity from barcodes and is superseded by the current per-sample InferCNA
#     pipeline plus centred subclone workflows; do not use downstream.
#   Inputs: historical ref_outs/by_samples/*_PDO/*_outs.rds and external hg38 gene order.
#   Outputs: historical interactive heatmap device only; no current dependency.
