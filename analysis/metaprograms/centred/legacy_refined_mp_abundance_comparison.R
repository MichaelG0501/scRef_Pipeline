...
# Analysis registry:
#   Status: legacy
#   Script: analysis/metaprograms/centred/legacy_refined_mp_abundance_comparison.R
...
#   Rscript analysis/metaprograms/centred/legacy_refined_mp_abundance_comparison.R
#
# Conda env: dmtcp
####################
